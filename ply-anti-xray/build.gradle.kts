...
dependencies {
    ...
    include(modImplementation("com.github.the-glitch-network", "bytecode-junkie", "v0.3.2"))
...
modrinth {
    ...
    changelog.set(
        System.getenv("CHANGELOG") ?: if (ref != null && ref.startsWith("refs/tags/")) "You may view the changelog at https://github.com/the-glitch-network/plymouth-fabric/releases/tag/${com.google.common.net.UrlEscapers.urlFragmentEscaper().escape(ref.substring(10))}"
