...
tasks {
    ...
    val publishToModrinth = register<TaskModrinthUpload>("publishToModrinth") {
        ...
        changelog = System.getenv("CHANGELOG") ?: if (ref.startsWith("refs/tags/")) "You may view the changelog at https://github.com/Modflower/plymouth-fabric/releases/tag/${com.google.common.net.UrlEscapers.urlFragmentEscaper().escape(ref.substring(10))}"
