...
public class Standalone {
    public static void main(final String[] args) {
        try {
            ...
            if (JOptionPane.showOptionDialog(null, "Please put Plymouth in your mods folder.\nIt'll be located at `" + path.toAbsolutePath() + "`.\n\nWould you like that folder to be opened?", "Plymouth Mod", JOptionPane.YES_NO_OPTION, JOptionPane.ERROR_MESSAGE, null, null, null) == JOptionPane.YES_OPTION) {
                Desktop.getDesktop().browseFileDirectory(path.toFile());
            }
        } catch (Exception e) {
            System.out.println("======= Plymouth Mod =======");
            System.out.println("Please install Plymouth in the mods folder that has been generated by the server.");
